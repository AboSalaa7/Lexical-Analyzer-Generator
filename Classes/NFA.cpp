...
int main() {
   ...
   /* cout<< "print a "<<endl;
    ...
    NFA s = k.create_NFA(c);
    cout<< "print c "<<endl;
    s.print_NFA();

    test.kleene_closure(test);
    cout<< "print a* "<<endl;
    test.print_NFA();

    test.concatenate(test,res);
    cout<< "print a*b "<<endl;
    test.print_NFA();

    k.Union(k, test); 
    cout<< "print c + a*b"<<endl;
    k.print_NFA();
    ...
    test.concatenate(test,k);
    cout<< "print a*b (c + a*b)* "<<endl;
    test.print_NFA();

    test.concatenate(test,res);
    cout<< "print a*b (c + a*b)* b"<<endl;
    test.print_NFA();

    test.Union(test,s);
    cout<< "print a*b (c + a*b)* + c"<<endl;
    test.print_NFA();
